...
Existing FitText write totality, simultaneous consistent regional initial values, EntryState JSON, iterative MemoryUnion JSON and UnknownBinding/UnknownType transport. Model AIR 2.0.0 and JSON binding 1.0.0 are unchanged.

## Validation

184 model + 116 transport deterministic checks; 39 harness tests; module/bytecode/contract checks.
